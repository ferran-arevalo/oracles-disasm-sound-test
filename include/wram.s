...
wSelectedMusic: ; $c580
; music selected in the sound test
	db

wSelectedSfx: ; $c581
; sfx selected in the sound test
	db

wMusicActive: ; $c582
;whether or not we are playing music in the sound test (just to know what the A button will do)
	db
...
wSoundTestCursor ; $c584
; 0 if cursor is on the MUS list, 1 if it is on the SND list
	db

wPlayingMusic: ; $c585
; music being played in the sound test
	db

wPlayingSfx: ; $c586
; sfx being played in the sound test
	db
