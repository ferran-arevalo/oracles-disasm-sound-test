...
@state4:
	ld a,$4c
	ld (wSelectedSfx),a
	call soundTest_showAudioNames
	call soundTest_showAudioIndices
...
@state5:
	ld a,$4c
	ld (wSelectedSfx),a
	call soundTest_showAudioNames2
	call soundTest_showAudioIndices
...
@state0:
	call soundTest_updateAIcon	
	call soundTest_showAudioIndices

	call soundTest_updateCursor
	...
	jr nz,@changeSelectedAudio

	ret

;;
@aPressed:
	ld a,(wSoundTestCursor)
	or a
	jr z,@music
@sfx:
	ld a,$01
...
@@sfx:
	...
	ld a,$ff
	jr nz,+
	;here, our only options are either Left or Right. If it is not Left, then it is Right
	ld a,$01
+
	ld b,a
	ld a,(wSelectedSfx)
...
soundTest_showAudioNames:
	ld a,(wSelectedMusic)
	ld c,a

	ld b,>TX_0900

	call showTextOnInventoryMenu
	ret
soundTest_showAudioNames2:
	ld a,(wSelectedSfx)
	ld c,a

	ld b,>TX_0900

	call showTextOnInventoryMenu2
	ret
